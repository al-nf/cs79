...
3. edit all .h, *.cpp, and Makefile to your ID and email
...
Then edit "shuffle.cpp" to implement "shuffle" and "deal" member functions
for class Deck.  After that, make decktest and verify it is indeed working.

Last do poker.  There are two areas: one in poker.cpp and another in
pokermain.cpp.  In a sense, pokermain is testing poker.cpp.  Finish
"RankHand" in poker.cpp.  You probably should write test code (in
pokermain.cpp) just to verify that your RankHand is working.  This is
optional.

Then implement "PokerHands" in pokermain.cpp.  This function is supposed to
