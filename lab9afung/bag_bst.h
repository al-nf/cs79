...
#pragma mark - Member Function Implementation
    ...
    // Header file used: bintree.h
    {
        ...
        do
        {
            ...
            {   // Go left
                ...
                // STUDENT WORK
                if (cursor->left() == NULL) {
                    binary_tree_node<Item> *newnode = new binary_tree_node(entry);
                    cursor->set_left(newnode);
                    done = true;
                }
                cursor = cursor->left();
    ...
    void bag<Item>::operator +=(const bag<Item>& addend)
    {
        ...
        {
            root_ptr = tree_copy(addend.root_ptr);
            return;
        }
